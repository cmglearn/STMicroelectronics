...
#elif defined CPU_CLK_180_MHZ
  #define ADC_CLOCK_DIVIDER2  ADC_Prescaler_Div4
  #define TIM_CLOCK_DIVIDER2  2
  #define ADV_TIM_CLK_MHz2    180uL/TIM_CLOCK_DIVIDER
  #define ADC_CLK_MHz2        22uL // 22MHz
  #define HALL_TIM_CLK2       90000000uL
#else
  #warning "CPU_CLK defined in control stace is not supported implemented"
#endif
