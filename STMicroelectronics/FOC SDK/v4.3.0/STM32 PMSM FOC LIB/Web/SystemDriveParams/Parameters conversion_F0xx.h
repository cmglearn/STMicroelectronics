/**
  ******************************************************************************
  * @file    Parameters conversion_F0X.h
...
#define TIMx_BRK_M1_IRQFlag             2

#define DMAx_R1_M1_IRQHandler           DMA1_Channel4_5_IRQHandler
#define DMAx_R1_M1_TC_Flag              DMA1_FLAG_TC4

/* DMAx MC IRQ Flag*/
#define DMAx_TC_M1_IRQFlag              1
...
#if ((defined(STM32F051x))||(defined(STM32F072x)))
#define R1_PWM_AUX_TIM                  TIM15
#elif ((defined(STM32F050x)) || (defined(STM32F030x)) || (defined(STM32F031x)) || (defined(STSPIN32F0)))
...
#define SAMPLING_TIME_NS 	(CURR_SAMPLING_TIME * 1000uL/ADC_CLK_MHz)+SAMPLING_TIME_CORRECTION_FACTOR_NS
...
#define TW_BEFORE ((2*SAMPLING_TIME_NS)+ TRIG_CONV_LATENCY_NS + ADC_CONV_TIME_NS)*(ADV_TIM_CLK_MHz/1000ul)
