...
#define SYSCLK_FREQ_64MHz  64000000uL
#define TIM_CLOCK_DIVIDER  1
#define ADV_TIM_CLK_MHz    (64uL/TIM_CLOCK_DIVIDER)
#define ADC_CLK_MHz        (64uL/ADC_CLOCK_DIV)
#define HALL_TIM_CLK       SYSCLK_FREQ_64MHz
