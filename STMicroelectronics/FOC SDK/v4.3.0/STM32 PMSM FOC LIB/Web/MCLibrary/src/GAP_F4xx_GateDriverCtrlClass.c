...
{
  pDParams_t pDParams = DCLASS_PARAMS;
  pDParams->hNSDPort->BSRRL = pDParams->hNSDPin;
}
...
{
  pDParams_t pDParams = DCLASS_PARAMS;
  pDParams->hNSDPort->BSRRH = pDParams->hNSDPin;
}
...
{
  pDParams_t pDParams = DCLASS_PARAMS;
  pDParams->hNCSPort->BSRRL = pDParams->hNCSPin;
}
...
{
  pDParams_t pDParams = DCLASS_PARAMS;
  pDParams->hNCSPort->BSRRH = pDParams->hNCSPin;
}
